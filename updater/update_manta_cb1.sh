...
make KCONFIG_CONFIG=/home/Volumic/printer_data/config/.volumic/updater/config.manta flash FLASH_DEVICE=/dev/serial/by-path/platform-5200000.usb-usb-0:1.4:1.0
